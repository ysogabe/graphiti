...
class LLMConfig:
    ...
    def __init__(
        ...
        Args:
                ...
                reasoning_effort (str, optional): Reasoning effort forwarded to OpenAI-compatible
                                                                chat-completions endpoints (e.g. b.ai). Only set for reasoning
                                                                models that accept it; None means it is not sent.
        """
